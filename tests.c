...
int main(void)
{
	...
	suite("ChaCha20 Cipher Test Vector #0 (Chunked)")
	{
		key256_t key = {
			0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
			0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
		...
		for(size_t i = 0; i < sizeof(data); i += 10)
			ChaCha20_xor(&ctx, &data[i], (10 < sizeof(data) - i ? 10 : sizeof(data) - i));
	...
	suite("ChaCha20 Cipher Test Vector #1 (Chunked)")
	{
		key256_t key = {
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	suite("ChaCha20 Cipher Test Vector #2 (Chunked)")
	{
		key256_t key = {
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	suite("ChaCha20 Cipher Test Vector #3 (Chunked)")
	{
		key256_t key = {
			0x1c, 0x92, 0x40, 0xa5, 0xeb, 0x55, 0xd3, 0x8a,
			0xf3, 0x33, 0x88, 0x86, 0x04, 0xf6, 0xb5, 0xf0,
